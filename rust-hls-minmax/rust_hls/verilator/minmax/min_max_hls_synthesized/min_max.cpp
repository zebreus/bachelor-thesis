...
extern "C" {
  ...
  void
  min_max_set_Pd5(Vmin_max* __ptr, vluint32_t __v) {
    __ptr->Pd5 = __v;
  }

  void
  min_max_set_Pd6(Vmin_max* __ptr, vluint32_t __v) {
    __ptr->Pd6 = __v;
  }

  void
  min_max_set_Pd7(Vmin_max* __ptr, vluint32_t __v) {
    __ptr->Pd7 = __v;
  }

  void
  min_max_set_Pd8(Vmin_max* __ptr, vluint32_t __v) {
    __ptr->Pd8 = __v;
  }
