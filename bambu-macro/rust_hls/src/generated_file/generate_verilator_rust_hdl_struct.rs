...
use extract_rust_hdl_interface::{RustHdlModule, Signal};
...
pub fn generate_rust_hdl_struct(
    ...
    generate_rust_hdl_struct_internal;

    Ok(token_stream)
}

pub fn generate_rust_hdl_struct_internal(
    verilog: &str,
    module_name: &str,
    struct_name: &str,
    parameter_names: &Vec<String>,
    parsed_module: &mut RustHdlModule,
    verilated_module: ItemMod,
    verilated_module_name: Ident,
    verilated_struct_ident: Ident,
) -> Result<syn::File, GenerateRustHdlStructError> {
