...
:vega-lite-filename: processed-charts/chart_estimated_area.vl.json
include::vega-chart.adoc[]

.Maximum frequency of the different minmax designs

.Average clock cycles per test of the different minmax designs
