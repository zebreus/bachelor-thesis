...
In case of the crates.io design it did not make any difference whether it was optimized for speed or for size. This 
...
[source#keccak-crates-source-listing.linenums.hundred_max,rust]
----
