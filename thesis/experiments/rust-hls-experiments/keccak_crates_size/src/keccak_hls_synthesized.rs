...
// rust_hls hash: "f55d4e2995391f46a14ba3ba0fa19953"
...
impl ::rust_hdl::prelude::Logic for Keccak {
    fn update(&mut self) {
        ...
        verilated_module.set_Pd226(self.input_pointer.val().to_u32());
