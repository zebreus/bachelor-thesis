...
// Code created using PandA - Version: PandA 0.9.8 - Revision 891ec3caed502474cab0813cc4a9fc678deabaa5 - Date 2023-02-13T18:17:23
// /nix/store/2hfjp458bdl98q37hzi2aljm30kda30v-bambu-wrapped/bin/bambu executed with: /nix/store/2hfjp458bdl98q37hzi2aljm30kda30v-bambu-wrapped/bin/bambu --top-fname=state_test --clock-name=clk --compiler=I386_CLANG12 -Os state_test.cpp 
// 
...
module datapath_state_test(clock,
  ...
  wrenable_reg_0);
  parameter MEM_var_424742_424719=32;
  // IN
  input clock;
  input reset;
  ...
  wire null_out_signal_array_424742_0_Sout_DataRdy_0;
  wire null_out_signal_array_424742_0_Sout_DataRdy_1;
  wire [31:0] null_out_signal_array_424742_0_Sout_Rdata_ram_0;
  wire [31:0] null_out_signal_array_424742_0_Sout_Rdata_ram_1;
  wire [31:0] null_out_signal_array_424742_0_out1_1;
  wire [31:0] null_out_signal_array_424742_0_proxy_out1_0;
  wire [31:0] null_out_signal_array_424742_0_proxy_out1_1;
  wire [31:0] out_ARRAY_1D_STD_DISTRAM_NN_SDS_0_i0_array_424742_0;
  wire [5:0] out_addr_expr_FU_3_i0_fu_state_test_424719_424767;
  wire [5:0] out_addr_expr_FU_4_i0_fu_state_test_424719_424770;
  wire [6:0] out_const_0;
  wire out_const_1;
  wire [5:0] out_const_2;
  wire [5:0] out_conv_out_const_0_7_6;
  wire [31:0] out_conv_out_const_2_6_32;
  wire [31:0] out_reg_0_reg_0;
  wire [31:0] out_ui_plus_expr_FU_32_0_32_6_i0_fu_state_test_424719_424733;
  ...
  ASSIGN_VECTOR_BOOL_FU #(.BITSIZE_in1(32),
    ...
    .in1(out_ui_plus_expr_FU_32_0_32_6_i0_fu_state_test_424719_424733));
  ARRAY_1D_STD_DISTRAM_NN_SDS #(.BITSIZE_in1(32),
    ...
    .MEMORY_INIT_file("/home/lennart/Documents/bachelor-thesis/hardware-tang/array_ref_424742.mem"),
    .n_elements(1),
    .data_size(32),
    .address_space_begin(MEM_var_424742_424719),
    ...
    .PORTSIZE_proxy_out1(2)) array_424742_0 (.out1({null_out_signal_array_424742_0_out1_1,
      out_ARRAY_1D_STD_DISTRAM_NN_SDS_0_i0_array_424742_0}),
    .Sout_Rdata_ram({null_out_signal_array_424742_0_Sout_Rdata_ram_1,
      null_out_signal_array_424742_0_Sout_Rdata_ram_0}),
    .Sout_DataRdy({null_out_signal_array_424742_0_Sout_DataRdy_1,
      null_out_signal_array_424742_0_Sout_DataRdy_0}),
    .proxy_out1({null_out_signal_array_424742_0_proxy_out1_1,
      null_out_signal_array_424742_0_proxy_out1_0}),
    .clock(clock),
    .reset(reset),
    .in1({out_vb_assign_conn_obj_0_ASSIGN_VECTOR_BOOL_FU_vb_assign_0,
      32'b00000000000000000000000000000000}),
    .in2({out_addr_expr_FU_4_i0_fu_state_test_424719_424770,
      out_addr_expr_FU_3_i0_fu_state_test_424719_424767}),
  ...
  constant_value #(.BITSIZE_out1(6),
    .value(MEM_var_424742_424719)) const_2 (.out1(out_const_2));
  ...
  UUdata_converter_FU #(.BITSIZE_in1(6),
    .BITSIZE_out1(32)) conv_out_const_2_6_32 (.out1(out_conv_out_const_2_6_32),
    .in1(out_const_2));
  ui_plus_expr_FU #(.BITSIZE_in1(32),
    .BITSIZE_in2(1),
    .BITSIZE_out1(32)) fu_state_test_424719_424733 (.out1(out_ui_plus_expr_FU_32_0_32_6_i0_fu_state_test_424719_424733),
    .in1(out_ARRAY_1D_STD_DISTRAM_NN_SDS_0_i0_array_424742_0),
    .in2(out_const_1));
  addr_expr_FU #(.BITSIZE_in1(32),
    .BITSIZE_out1(6)) fu_state_test_424719_424767 (.out1(out_addr_expr_FU_3_i0_fu_state_test_424719_424767),
    .in1(out_conv_out_const_2_6_32));
  addr_expr_FU #(.BITSIZE_in1(32),
    .BITSIZE_out1(6)) fu_state_test_424719_424770 (.out1(out_addr_expr_FU_4_i0_fu_state_test_424719_424770),
    .in1(out_conv_out_const_2_6_32));
...
// FSM based controller description for state_test
// This component has been derived from the input source code and so it does not fall under the copyright of PandA framework, but it follows the input source code copyright, and may be aggregated with components of the BAMBU/PANDA IP LIBRARY.
// Author(s): Component automatically generated by bambu
// License: THIS COMPONENT IS PROVIDED "AS IS" AND WITHOUT ANY EXPRESS OR IMPLIED WARRANTIES, INCLUDING, WITHOUT LIMITATION, THE IMPLIED WARRANTIES OF MERCHANTIBILITY AND FITNESS FOR A PARTICULAR PURPOSE.
`timescale 1ns / 1ps
module controller_state_test(done_port,
  fuselector_ARRAY_1D_STD_DISTRAM_NN_SDS_0_i0_LOAD,
  fuselector_ARRAY_1D_STD_DISTRAM_NN_SDS_0_i0_STORE,
  fuselector_ARRAY_1D_STD_DISTRAM_NN_SDS_0_i1_LOAD,
  fuselector_ARRAY_1D_STD_DISTRAM_NN_SDS_0_i1_STORE,
...
// Top component for state_test
// This component has been derived from the input source code and so it does not fall under the copyright of PandA framework, but it follows the input source code copyright, and may be aggregated with components of the BAMBU/PANDA IP LIBRARY.
// Author(s): Component automatically generated by bambu
// License: THIS COMPONENT IS PROVIDED "AS IS" AND WITHOUT ANY EXPRESS OR IMPLIED WARRANTIES, INCLUDING, WITHOUT LIMITATION, THE IMPLIED WARRANTIES OF MERCHANTIBILITY AND FITNESS FOR A PARTICULAR PURPOSE.
`timescale 1ns / 1ps
module _state_test(clock,
  reset,
  start_port,
  done_port,
  return_port);
  ...
  controller_state_test Controller_i (.done_port(done_delayed_REG_signal_in),
  ...
  datapath_state_test #(.MEM_var_424742_424719(32)) Datapath_i (.return_port(return_port),
    .clock(clock),
    .reset(reset),
    .fuselector_ARRAY_1D_STD_DISTRAM_NN_SDS_0_i0_LOAD(fuselector_ARRAY_1D_STD_DISTRAM_NN_SDS_0_i0_LOAD),
    .fuselector_ARRAY_1D_STD_DISTRAM_NN_SDS_0_i0_STORE(fuselector_ARRAY_1D_STD_DISTRAM_NN_SDS_0_i0_STORE),
...
// Minimal interface for function: state_test
// This component has been derived from the input source code and so it does not fall under the copyright of PandA framework, but it follows the input source code copyright, and may be aggregated with components of the BAMBU/PANDA IP LIBRARY.
// Author(s): Component automatically generated by bambu
// License: THIS COMPONENT IS PROVIDED "AS IS" AND WITHOUT ANY EXPRESS OR IMPLIED WARRANTIES, INCLUDING, WITHOUT LIMITATION, THE IMPLIED WARRANTIES OF MERCHANTIBILITY AND FITNESS FOR A PARTICULAR PURPOSE.
`timescale 1ns / 1ps
module state_test(clk,
  reset,
  start_port,
  done_port,
  return_port);
  ...
  _state_test _state_test_i0 (.done_port(done_port),
