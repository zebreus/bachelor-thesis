...
[NOTE]
====
There also is https://github.com/samitbasu/rust-hdl[rust-hdl] uses a subset of Rust as a HDL. It does not do high-level synthesis, but allows you to write, simulate and verify RTL logic directly in Rust. If you interested in FPGA programming, you should definitely check it out.
====
