...
FPGAs on the other hand are not designed to process one instructions at a time. They are not even designed to process instructions at all. They dont even know what an instruction is. But if they dont know what an instruction is, how can they process anything? Well, they dont. They are not designed to process anything. They are designed to be reprogrammable. This does not explain anything TODO: write more
